...
public class EditParagraphP7 extends AppCompatActivity {
    ...
    private void updateParagraph(String getIdExam,String getIdQues){
        ...
        ref.child("paragraph").setValue(ContentQues).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(EditParagraphP7.this, "Sửa thành công!!!", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EditParagraphP7.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
    }
