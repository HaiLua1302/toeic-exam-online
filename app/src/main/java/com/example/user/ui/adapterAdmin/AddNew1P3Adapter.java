...
import com.example.user.ui.admin.part3.AddNewQues2P3Activity;
import com.example.user.ui.classExam.ClsRecExamP3;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class AddNew1P3Adapter extends FirebaseRecyclerAdapter<ClsRecExamP3, AddNew1P3Adapter.AddNew1P3Holder> {
    private String nameExam;
    private Context context;

    public AddNew1P3Adapter(@NonNull FirebaseRecyclerOptions<ClsRecExamP3> options, String nameExam, Context context) {
        super(options);
        this.nameExam = nameExam;
        this.context = context;
    }

    public AddNew1P3Adapter(@NonNull FirebaseRecyclerOptions<ClsRecExamP3> options) {
        super(options);
    }
    ...
    public class AddNew1P3Holder extends RecyclerView.ViewHolder {
        ...
        private void sendData(ClsRecExamP3 model,int pos){
            Intent intent = new Intent(itemView.getContext(), AddNewQues2P3Activity.class);
