...
import com.example.user.ui.admin.part7.AddNewQues2P7;
import com.example.user.ui.classExam.ClsRecExamP7;
import com.example.user.ui.classExam.ClsRecExamP7;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class AdtAddNew1P7 extends FirebaseRecyclerAdapter<ClsRecExamP7,AdtAddNew1P7.AddNew1P7Holder> {
    private String nameExam;
    private Context context;

    public AdtAddNew1P7(@NonNull FirebaseRecyclerOptions<ClsRecExamP7> options, String nameExam, Context context) {
        super(options);
        this.nameExam = nameExam;
        this.context = context;
    }

    public AdtAddNew1P7(@NonNull FirebaseRecyclerOptions<ClsRecExamP7> options) {
        super(options);
    }
    ...
    public class AddNew1P7Holder extends RecyclerView.ViewHolder {
        ...
        private void sendData(ClsRecExamP7 model,int pos){
            Intent intent = new Intent(itemView.getContext(), AddNewQues2P7.class);
