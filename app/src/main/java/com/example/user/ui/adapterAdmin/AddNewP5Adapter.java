...
public class AddNewP5Adapter extends FirebaseRecyclerAdapter<ClsPartP5, AddNewP5Adapter.AddNewP5Holder> {
    private String nameExam;
    private Context context;

    public AddNewP5Adapter(@NonNull FirebaseRecyclerOptions<ClsPartP5> options, String nameExam, Context context) {
        super(options);
        this.nameExam = nameExam;
        this.context = context;
    }

    public AddNewP5Adapter(@NonNull FirebaseRecyclerOptions<ClsPartP5> options) {
        super(options);
    }
