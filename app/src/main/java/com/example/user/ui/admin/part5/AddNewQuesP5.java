...
import com.example.user.ui.adapterAdmin.AdtAddNewP5;
...
public class AddNewQuesP5 extends AppCompatActivity {

    private EditText edtNameExam;
    private ImageView imgRefresh;
    private Button btnAddNew;
    private RecyclerView recyclerView;
    private AdtAddNewP5 adtAddNewP5;
...
//                checkDuplicate();
    ...
    private void sendNameExam(){
        ...
        intent = new Intent(AddNewQuesP5.this,AddNewAQuesP5.class);
    ...
    private void setDataToRecViewDefault(){
        ...
        if (nameExam.isEmpty()){
            ...
            adtAddNewP5 = new AdtAddNewP5(options,nameExam,this);
            recyclerView.setAdapter(adtAddNewP5);
            adtAddNewP5.startListening();
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
             case android.R.id.home:
                intent = new Intent(AddNewQuesP5.this, ManagerExamActivity.class);
                startActivity(intent);
            case R.id.home_bar_admin:
                intent = new Intent(AddNewQuesP5.this, AdminHome.class);
                startActivity(intent);
                return true;
        }
