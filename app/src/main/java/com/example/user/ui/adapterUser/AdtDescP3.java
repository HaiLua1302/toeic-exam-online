...
import com.example.user.ui.user.exam3.ResultP3Activity;
...
public class AdtDescP3 extends RecyclerView.Adapter<AdtDescP3.DescP3Holder> {
    private List<ClsRecExamP3>clsRecExamP3s;

    public AdtDescP3(List<ClsRecExamP3> clsRecExamP3s) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdtDescP3.DescP3Holder holder, int position) {
        ...
        public DescP3Holder(@NonNull View itemView) {
            ...
            btnSubmitHolder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), ResultP3Activity.class);
