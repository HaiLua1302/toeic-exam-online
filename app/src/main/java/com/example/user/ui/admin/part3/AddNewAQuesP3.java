...
public class AddNewAQuesP3 extends AppCompatActivity {
        ...
        ref.child(ID_Quest).setValue(clsRecExamP3).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(AddNewAQuesP3.this, "Thêm câu hỏi thành công", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(AddNewAQuesP3.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.home_bar_admin:
                Intent intent2 = new Intent(AddNewAQuesP3.this, AdminHome.class);
