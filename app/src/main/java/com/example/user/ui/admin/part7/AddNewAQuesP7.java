...
public class AddNewAQuesP7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_a_ques_p2);
        ...
        ref.child(ID_Quest).setValue(clsRecExamP7).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(AddNewAQuesP7.this, "Thêm bộ đề thành công", Toast.LENGTH_SHORT).show();
                    countQues++;
                    txtCountQues.setText(String.valueOf(countQues));
                }
                else {
                    Toast.makeText(AddNewAQuesP7.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.home_bar_admin:
                Intent intent2 = new Intent(AddNewAQuesP7.this, AddNewQues2P7.class);
