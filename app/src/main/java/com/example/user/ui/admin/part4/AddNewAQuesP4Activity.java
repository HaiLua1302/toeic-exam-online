...
public class AddNewAQuesP4Activity extends AppCompatActivity {
        ...
        ref.child(ID_Quest).setValue(clsRecExamP4).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(AddNewAQuesP4Activity.this, "Thêm câu hỏi thành công", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(AddNewAQuesP4Activity.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
