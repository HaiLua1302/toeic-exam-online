...
public class EditParagraphP6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtIdExam = findViewById(R.id.txtNameExamQuesEditP6);
    ...
    private void updateParagraph(String getIdExam,String getIdQues){
        ...
        ref.child("paragraph").setValue(ContentQues).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(EditParagraphP6.this, "Sửa thành công!!!", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EditParagraphP6.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
    }
