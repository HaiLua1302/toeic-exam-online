...
public class AddNew2P3Adapter extends RecyclerView.Adapter<AddNew2P3Adapter.RecViewPart3Holder> {
    private List<String> getKey;
    private List<Integer> countTotal;

    public AddNew2P3Adapter() {
    }

    public AddNew2P3Adapter(List<String> getKey, List<Integer> countTotal) {
        this.getKey = getKey;
    ...
    @NonNull
    @Override
    public AddNew2P3Adapter.RecViewPart3Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_rec_add_new_part3,parent,false);
        return new AddNew2P3Adapter.RecViewPart3Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddNew2P3Adapter.RecViewPart3Holder holder, int position) {
