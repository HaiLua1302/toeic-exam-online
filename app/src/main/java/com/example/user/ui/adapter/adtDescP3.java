...
public class adtDescP3 extends FirebaseRecyclerAdapter<clsRecP3,adtDescP3.DescP3Holder> {

    public adtDescP3(@NonNull FirebaseRecyclerOptions<clsRecP3> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull adtDescP3.DescP3Holder holder, int position, @NonNull clsRecP3 model) {
    ...
    public class DescP3Holder extends RecyclerView.ViewHolder {
        ...
        private List<clsQuestionP3> questionP3sHolder ;
        ...
        private void setData(clsRecP3 model){
            DatabaseReference ref1 = FirebaseDatabase.getInstance()
                    .getReference("List_Ques3").child(model.getId_exam() + "/" + model.getId_question() + "/Question");
            ...
            ref1.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                        clsQuestionP3 recP3 = dataSnapshot.getValue(clsQuestionP3.class);
        ...
        private void prepareMediaPlayer(clsRecP3 model){
            try{
