...
public class ClsPartP5 {
    String id_ques,id_exam,ques_content,ans_a,ans_b,ans_c,ans_d,result;

    public ClsPartP5() {
    }

    public ClsPartP5(String id_ques, String id_exam, String ques_content, String ans_a, String ans_b, String ans_c, String ans_d, String result) {
