...
public class AddNewListQuesP1Activity extends AppCompatActivity {
    ...
    private void addListQues(String url_img){
        //getting the reference of question part 1 node
        databaseQuest_p1 = FirebaseDatabase.getInstance().getReference("List_Ques1").child(idExam);
        String Result = edtResult.getText().toString();
        String child = idExam + "_" + getTime();
        ClsPartP1 clsPartP1 = new ClsPartP1(Result,url_img,child);
    ...
    private void saveQuesImage()
    {
        ...
        if(filePath_IMG != null)
        {
            ...
            ref_IMG.putFile(filePath_IMG)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ref_IMG.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(AddNewListQuesP1Activity.this, "Thêm câu hỏi "+countNumQues+" thành công ", Toast.LENGTH_SHORT).show();
                                    countNumQues++;
                                    txtNumQues.setText(String.valueOf(countNumQues));
                                }
                            });
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(AddNewListQuesP1Activity.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            ...
            Toast.makeText(AddNewListQuesP1Activity.this, "File Image Chưa Được Chọn", Toast.LENGTH_SHORT).show();
        }
    }
