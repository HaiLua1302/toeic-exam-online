...
//        String child = id_exam + "/" + String.valueOf(id_question);
        FirebaseRecyclerOptions<clsRecP3> options = new FirebaseRecyclerOptions.Builder<clsRecP3>()
                .setQuery(FirebaseDatabase.getInstance().getReference("Ques_3").child(id_exam),clsRecP3.class)
                .build();
