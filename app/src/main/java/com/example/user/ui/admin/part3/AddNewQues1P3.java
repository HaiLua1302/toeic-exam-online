...
import com.example.user.ui.adapterAdmin.AdtAddNew1P3;
...
public class AddNewQues1P3 extends AppCompatActivity {
    ...
    private AdtAddNew1P3 adtAddNew1P3;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    saveAudio();
                    Toast.makeText(AddNewQues1P3.this, "Thêm câu hỏi thành công ",Toast.LENGTH_SHORT).show();
                }
    ...
    private void addQues(String url_audio) {
        ...
        String ID_Quest = "QuesP3"+ id_Exam +"_"+ getTime();
        ...
        ref.child(ID_Quest).setValue(clsRecExamP3).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(AddNewQues1P3.this, "Thêm bộ đề thành công", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(AddNewQues1P3.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private void saveAudio(){
        ...
        if(filePath_AUD != null) {
            ...
            ref_AUD.putFile(filePath_AUD)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog_audio.dismiss();
                            Toast.makeText(AddNewQues1P3.this, "Đã xảy ra lỗi vui lòng thử lại " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            ...
            Toast.makeText(AddNewQues1P3.this, "File Audio Chưa Được Chọn ", Toast.LENGTH_SHORT).show();
        }
    ...
    private void setDataToRecViewDefault(){
        ...
        if (nameExam.isEmpty()){
            ...
            adtAddNew1P3 = new AdtAddNew1P3(options,nameExam,this);
            recyclerView.setAdapter(adtAddNew1P3);
            adtAddNew1P3.startListening();
        }
    }
    /*
   gettime current
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(AddNewQues1P3.this, ManagerExamActivity.class);
                startActivity(intent);
            case R.id.home_bar_admin:
                Intent intent2 = new Intent(AddNewQues1P3.this, AdminHome.class);
