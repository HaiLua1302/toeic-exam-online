...
import com.example.user.ui.admin.fullExam.AddNewAPart;
import com.example.user.ui.classExam.ClsRecExamFull;

import java.util.List;

public class AdtRecExamFull extends RecyclerView.Adapter<AdtRecExamFull.RecExamFullHolder> {
    private List<String> getKey;
    private List<ClsRecExamFull> clsRecExamFulls;

    public AdtRecExamFull() {
    }

    public AdtRecExamFull(List<String> getKey, List<ClsRecExamFull> clsRecExamFulls) {
        this.getKey = getKey;
    ...
    public class RecExamFullHolder extends RecyclerView.ViewHolder {
        ...
        private void sendDataEdit(int pos){
            ...
            Intent intent = new Intent(itemView.getContext(), AddNewAPart.class);
