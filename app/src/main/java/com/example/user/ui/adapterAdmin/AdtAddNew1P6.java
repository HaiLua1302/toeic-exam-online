...
import com.example.user.ui.admin.part6.AddNewQues2P6;
import com.example.user.ui.classExam.ClsRecExamP6;
import com.example.user.ui.classExam.ClsRecExamP6;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class AdtAddNew1P6 extends FirebaseRecyclerAdapter<ClsRecExamP6,AdtAddNew1P6.AddNew1P6Holder> {
    private String nameExam;
    private Context context;

    public AdtAddNew1P6(@NonNull FirebaseRecyclerOptions<ClsRecExamP6> options, String nameExam, Context context) {
        super(options);
        this.nameExam = nameExam;
        this.context = context;
    }

    public AdtAddNew1P6(@NonNull FirebaseRecyclerOptions<ClsRecExamP6> options) {
        super(options);
    }
    ...
    public class AddNew1P6Holder extends RecyclerView.ViewHolder {
        ...
        private void sendData(ClsRecExamP6 model,int pos){
            Intent intent = new Intent(itemView.getContext(), AddNewQues2P6.class);
