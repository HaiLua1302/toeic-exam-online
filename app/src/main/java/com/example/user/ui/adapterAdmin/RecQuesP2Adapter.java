...
public class RecQuesP2Adapter extends FirebaseRecyclerAdapter<ClsPartP2 , RecQuesP2Adapter.testHolder> {
    private String nameExam;
    private Context context;

    public RecQuesP2Adapter(@NonNull FirebaseRecyclerOptions<ClsPartP2> options, String nameExam, Context context) {
        super(options);
        this.nameExam = nameExam;
        this.context = context;
    }

    public RecQuesP2Adapter(@NonNull FirebaseRecyclerOptions<ClsPartP2> options) {
        super(options);
    }
