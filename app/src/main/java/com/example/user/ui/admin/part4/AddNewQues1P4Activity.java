...
public class AddNewQues1P4Activity extends AppCompatActivity {
    ...
    private AddNew1P4Adapter addNew1P4Adapter;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    saveAudio();
                    Toast.makeText(AddNewQues1P4Activity.this, "Thêm câu hỏi thành công ",Toast.LENGTH_SHORT).show();
                }
    ...
    private void addQues(String url_audio) {
        ...
        String ID_Quest = "P4_"+ id_Exam +"_"+ getTime();
        ...
        ref.child(ID_Quest).setValue(clsRecExamP4).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(AddNewQues1P4Activity.this, "Thêm bộ đề thành công", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(AddNewQues1P4Activity.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private void saveAudio(){
        ...
        if(filePath_AUD != null) {
            ...
            ref_AUD.putFile(filePath_AUD)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog_audio.dismiss();
                            Toast.makeText(AddNewQues1P4Activity.this, "Đã xảy ra lỗi vui lòng thử lại " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            ...
            Toast.makeText(AddNewQues1P4Activity.this, "File Audio Chưa Được Chọn ", Toast.LENGTH_SHORT).show();
        }
    ...
    private void getDatabyEdit()
    {
        ...
        Intent intent = new Intent(AddNewQues1P4Activity.this, AddNewQues2P4Activity.class);
        intent.putExtra("idExam",id_Exam);
        startActivity(intent);
    }
    ...
    private void setDataToRecViewDefault(){
        ...
        if (nameExam.isEmpty()){
            ...
            addNew1P4Adapter = new AddNew1P4Adapter(options,nameExam,this);
            recyclerView.setAdapter(addNew1P4Adapter);
            addNew1P4Adapter.startListening();
        }
    }
    /*
   gettime current
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(AddNewQues1P4Activity.this, ManagerExamActivity.class);
                startActivity(intent);
