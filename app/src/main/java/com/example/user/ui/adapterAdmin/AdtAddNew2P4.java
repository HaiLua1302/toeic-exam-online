...
public class AdtAddNew2P4 extends RecyclerView.Adapter<AdtAddNew2P4.RecViewPart3Holder> {
    ...
    public AdtAddNew2P4(List<String> getKey, List<Integer> countTotal) {
        this.getKey = getKey;
    ...
    @NonNull
    @Override
    public AdtAddNew2P4.RecViewPart3Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_rec_add_new_part3,parent,false);
        return new AdtAddNew2P4.RecViewPart3Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdtAddNew2P4.RecViewPart3Holder holder, int position) {
