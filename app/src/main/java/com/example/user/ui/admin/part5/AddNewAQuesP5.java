...
public class AddNewAQuesP5 extends AppCompatActivity {
        ...
        ref.setValue(clsRecExamP5).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(AddNewAQuesP5.this, "Thêm câu hỏi thành công", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(AddNewAQuesP5.this, "Đã xảy ra lỗi vui lòng thử lại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.home_bar_admin:
                Intent intent2 = new Intent(AddNewAQuesP5.this, AdminHome.class);
