...
import com.example.user.ui.adapterAdmin.AdtAddNew2P7;
...
public class AddNewQues2P7 extends AppCompatActivity {
    ...
    private AdtAddNew2P7 adtNewQues2P7;
    ...
    private void sendDataEditParagraph(String getIdExam,String getIdQues,String getParagraph){
        intent = new Intent(AddNewQues2P7.this, EditParagraphP7.class);
        intent.putExtra("idExam",getIdExam);
        intent.putExtra("idQues",getIdQues);
    ...
    private void setDataToRecViewDefault(String getIdExam,String getIdQues){
        ...
        FirebaseRecyclerOptions<ClsListQuestionP7> options =
                new FirebaseRecyclerOptions.Builder<ClsListQuestionP7>()
                        ...
                        .build();
        adtNewQues2P7 = new AdtAddNew2P7(options,getIdExam,getIdQues,this);
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        FirebaseDatabase.getInstance().getReference()
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(AddNewQues2P7.this, "Xóa câu hỏi thành công ", Toast.LENGTH_SHORT).show();
