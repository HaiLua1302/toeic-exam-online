...
import com.example.user.ui.admin.part4.AddNewQues2P4Activity;
import com.example.user.ui.classExam.ClsRecExamP4;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class AddNew1P4Adapter extends FirebaseRecyclerAdapter<ClsRecExamP4, AddNew1P4Adapter.AddNew1P4Holder> {
    private String nameExam;
    private Context context;

    public AddNew1P4Adapter(@NonNull FirebaseRecyclerOptions<ClsRecExamP4> options, String nameExam, Context context) {
        super(options);
    ...
    public class AddNew1P4Holder extends RecyclerView.ViewHolder {
        ...
        private void sendData(ClsRecExamP4 model,int pos){
            Intent intent = new Intent(itemView.getContext(), AddNewQues2P4Activity.class);
