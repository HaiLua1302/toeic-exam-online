...
public class RecExamByPartAdapter extends RecyclerView.Adapter<RecExamByPartAdapter.RecPartExamHolder> {
    private List<String> getKey;
    private List<Integer> countTotal;
    private String keyExam;

    public RecExamByPartAdapter() {
    }

    public RecExamByPartAdapter(List<String> getKey, List<Integer> countTotal, String child) {
        this.getKey = getKey;
