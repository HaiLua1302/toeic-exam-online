 ...
 * Use the {@link DescFullP6Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DescFullP6Fragment extends Fragment {
    ...
    public DescFullP6Fragment() {
        // Required empty public constructor
    }

    private RecyclerView recyclerViewQuestionP6;
    private AdtDescFullP6 adtDescP6;
    private List<ClsRecExamP6> clsRecP6s;

    // TODO: Rename and change types and number of parameters
    public static DescFullP6Fragment newInstance(String param1, String param2) {
        DescFullP6Fragment fragment = new DescFullP6Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Ques_6").child("Exam1");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adtDescP6 = new AdtDescFullP6(clsRecP6s);
