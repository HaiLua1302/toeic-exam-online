...
public class ChooseAPart2Activity extends AppCompatActivity implements RecChoosePartAdapter.OnShareClickedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_a_part2);
        getSupportActionBar().setTitle("Select Part 3");
        ...
        txtIdExam = findViewById(R.id.txtIdExamFullP2);
        txtIdPart = findViewById(R.id.txtNameExamChooseP2);
        txtIdExam = findViewById(R.id.txtIdExamFullP2);
        recyclerView = findViewById(R.id.recViewExamP2);
        btnSavePart = findViewById(R.id.btnSavaP2);
    ...
    private void initRecyclerView() {
        ...
        recChoosePartAdapter.setOnShareClickedListener(ChooseAPart2Activity.this::ShareClicked);
        recyclerView.setAdapter(recChoosePartAdapter);
    }

    private void getDataFirebase(){
        keyExam = txtIdExam.getText().toString();
        ref = FirebaseDatabase.getInstance().getReference("Ques_2");
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(ChooseAPart2Activity.this,"Dữ liệu lôi vui lòng kiểm tra Firebase!",Toast.LENGTH_SHORT).show();
                }
