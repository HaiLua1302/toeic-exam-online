...
public class LoginAdmin extends AppCompatActivity {
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask){
        try{
            ...
            Toast.makeText(LoginAdmin.this,"Signed In Successfully",Toast.LENGTH_SHORT).show();
    ...
    private void FirebaseGoogleAuth(GoogleSignInAccount acct) {
        ...
        if (acct != null) {
            ...
            mAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(LoginAdmin.this, "Successful", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(LoginAdmin.this, "acc failed", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updateUI(FirebaseUser fUser){
        ...
        if(account !=  null){
            ...
            Toast.makeText(LoginAdmin.this,personName + personEmail ,Toast.LENGTH_SHORT).show();
        }
