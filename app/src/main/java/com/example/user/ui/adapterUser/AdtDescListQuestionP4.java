...
public class AdtDescListQuestionP4 extends RecyclerView.Adapter<AdtDescListQuestionP4.DescListQuestionP4Holder> {
    private List<ClsListQuestionP4> clsListQuestionP4List;

    public AdtDescListQuestionP4() {
    }

    public AdtDescListQuestionP4(List<ClsListQuestionP4> clsListQuestionP4List) {
        this.clsListQuestionP4List = clsListQuestionP4List;
    }

    @NonNull
    @Override
    public DescListQuestionP4Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_list_question_p3,parent,false);
        return new DescListQuestionP4Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DescListQuestionP4Holder holder, int position) {
    ...
    public class DescListQuestionP4Holder extends RecyclerView.ViewHolder {
        ...
        public DescListQuestionP4Holder(@NonNull View itemView) {
            super(itemView);
