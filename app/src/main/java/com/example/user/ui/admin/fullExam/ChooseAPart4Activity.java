...
public class ChooseAPart4Activity extends AppCompatActivity implements RecChoosePartAdapter.OnShareClickedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_a_part4);
        getSupportActionBar().setTitle("Select Part 4");
        ...
        txtIdExam = findViewById(R.id.txtIdExamFullP4);
        txtIdPart = findViewById(R.id.txtNameExamChooseP4);
        txtIdExam = findViewById(R.id.txtIdExamFullP4);
        recyclerView = findViewById(R.id.recViewExamP4);
        btnSavePart = findViewById(R.id.btnSavaP4);
    ...
    private void initRecyclerView() {
        ...
        recChoosePartAdapter.setOnShareClickedListener(ChooseAPart4Activity.this::ShareClicked);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(ChooseAPart4Activity.this,"Dữ liệu lôi vui lòng kiểm tra Firebase!",Toast.LENGTH_SHORT).show();
                }
