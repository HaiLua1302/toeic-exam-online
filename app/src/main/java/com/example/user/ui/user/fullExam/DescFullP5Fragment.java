...
import com.example.user.ui.adapterUser.AdtDescFullP5;
 ...
 * Use the {@link DescFullP5Fragment#newInstance} factory method to
 * create an instance of this fragment.
 *//*

public class DescFullP5Fragment extends Fragment {
    ...
    private AdtDescFullP5 adtDescP5;
    private List<ClsPartP5> clsRecP5s;

    public DescFullP5Fragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static DescFullP5Fragment newInstance(String param1, String param2) {
        DescFullP5Fragment fragment = new DescFullP5Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        clsRecP5s = new ArrayList<>();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Ques_5").child("Exam1");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adtDescP5 = new AdtDescFullP5(clsRecP5s);
