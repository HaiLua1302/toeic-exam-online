...
public class TutorialP5Activity extends AppCompatActivity {

    Button getRec;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tutorial_p5);
        ...
        getRec = findViewById(R.id.btn_okie_tutorial_p5);
        getRec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TutorialP5Activity.this, ScreenSwitchP5Activity.class);
