...
public class ChooseAPart3Activity extends AppCompatActivity implements RecChoosePartAdapter.OnShareClickedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_a_part3);
        ...
        txtIdExam = findViewById(R.id.txtIdExamFullP3);
        txtIdPart = findViewById(R.id.txtNameExamChooseP3);
        txtIdExam = findViewById(R.id.txtIdExamFullP3);
        recyclerView = findViewById(R.id.recViewExamP3);
        btnSavePart = findViewById(R.id.btnSavaP3);
    ...
    private void initRecyclerView() {
        ...
        recChoosePartAdapter.setOnShareClickedListener(ChooseAPart3Activity.this::ShareClicked);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(ChooseAPart3Activity.this,"Dữ liệu lôi vui lòng kiểm tra Firebase!",Toast.LENGTH_SHORT).show();
                }
