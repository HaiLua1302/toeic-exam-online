...
import com.example.user.ui.adapterUser.AdtDescFullP7;
 ...
 * Use the {@link DescFullP7Fragment#newInstance} factory method to
 * create an instance of this fragment.
 *//*

public class DescFullP7Fragment extends Fragment {
    ...
    private AdtDescFullP7 adtDescP7;
    private List<ClsRecExamP7> clsRecP7s;

    public DescFullP7Fragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static DescFullP7Fragment newInstance(String param1, String param2) {
        DescFullP7Fragment fragment = new DescFullP7Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Ques_7").child("Exam1");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adtDescP7 = new AdtDescFullP7(clsRecP7s);
