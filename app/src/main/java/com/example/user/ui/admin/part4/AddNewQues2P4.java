...
import com.example.user.ui.adapterAdmin.AdtAddNewAQuesP4;
...
public class AddNewQues2P4 extends AppCompatActivity {
    ...
    private AdtAddNewAQuesP4 adtAddNewAQuesP4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddNew.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(AddNewQues2P4.this, AddNewAQuesP4.class);
        ...
        btnDelExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.showDialog(AddNewQues2P4.this,"Bạn Có Chắc Là Muốn Xóa Nó Chứ ? ");
            }
        });
    }
    ...
    private void saveEditQues()
    {
        ...
        if(filePath_AUD != null)
        {
            ...
            ref_IMG.putFile(filePath_AUD)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ref_IMG.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(AddNewQues2P4.this, "Đã lưu thay đổi thành công ", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(AddNewQues2P4.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            ...
            Toast.makeText(AddNewQues2P4.this, "Chưa chọn file Audio ", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void setDataToRecViewDefault(){
        ...
        FirebaseRecyclerOptions<ClsListQuestionP4> options =
                new FirebaseRecyclerOptions.Builder<ClsListQuestionP4>()
                        ...
                        .build();
        adtAddNewAQuesP4 = new AdtAddNewAQuesP4(options,child,this);
        recyclerView.setAdapter(adtAddNewAQuesP4);
        adtAddNewAQuesP4.startListening();}
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        FirebaseDatabase.getInstance().getReference()
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(AddNewQues2P4.this, "Xóa câu hỏi thành công ", Toast.LENGTH_SHORT).show();
