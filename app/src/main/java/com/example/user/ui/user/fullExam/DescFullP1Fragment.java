...
public class DescFullP1Fragment extends Fragment {
    ...
    public DescFullP1Fragment(String idExam) {
        this.idExam = idExam;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("List_Ques1").child(idExam);
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adtDescFull1 = new AdtDescFullP1(clsPartP1s, idExam);
