...
public class ClsPartP5 {
    String id_exam,ans_a,ans_b,ans_c,ans_d,ques_content,result;

    public ClsPartP5() {
    }

    public ClsPartP5(String id_exam, String ans_a, String ans_b, String ans_c, String ans_d, String ques_content, String result) {
