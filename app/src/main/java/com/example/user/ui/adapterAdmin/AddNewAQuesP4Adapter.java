...
public class AddNewAQuesP4Adapter extends FirebaseRecyclerAdapter<ClsListQuestionP4, AddNewAQuesP4Adapter.RecListQuesP4Holder> {
    private String child;
    private Context context;

    public AddNewAQuesP4Adapter(@NonNull FirebaseRecyclerOptions<ClsListQuestionP4> options, String child, Context context) {
        super(options);
        this.child = child;
        this.context = context;
    }

    public AddNewAQuesP4Adapter(@NonNull FirebaseRecyclerOptions<ClsListQuestionP4> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull AddNewAQuesP4Adapter.RecListQuesP4Holder holder, int position, @NonNull ClsListQuestionP4 model) {
    ...
    @NonNull
    @Override
    public AddNewAQuesP4Adapter.RecListQuesP4Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_rec_view_question_admin,parent,false);
        return new AddNewAQuesP4Adapter.RecListQuesP4Holder(view);
    }
