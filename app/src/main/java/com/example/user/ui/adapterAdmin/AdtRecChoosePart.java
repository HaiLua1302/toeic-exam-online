...
public class AdtRecChoosePart extends RecyclerView.Adapter<AdtRecChoosePart.RecChoosePartHolder> {
    private String keyExam;
    private List<String> getKey;

    public OnShareClickedListener mCallback;

    public AdtRecChoosePart() {
    }
    ...
    public AdtRecChoosePart(String keyExam, List<String> getKey) {
